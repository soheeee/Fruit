...
struct Theme{
    ...
    static func Mango(){
        ...
        main2 = UIColor(red: CGFloat(255)/255, green: CGFloat(225)/255, blue: CGFloat(130)/255, alpha: 1.0)
        main3 = UIColor(red: CGFloat(254)/255, green: CGFloat(220)/255, blue: CGFloat(105)/255, alpha: 1.0)
        main4 = UIColor(red: CGFloat(253)/255, green: CGFloat(202)/255, blue: CGFloat(84)/255, alpha: 1.0)
