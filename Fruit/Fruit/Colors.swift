...
struct Theme{
    ...
    static func Peach(){
        ...
        main1 = UIColor(red: CGFloat(254)/255, green: CGFloat(222)/255, blue: CGFloat(187)/255, alpha: 1.0)
    ...
    static func Mango(){
        ...
        main1 = UIColor(red: CGFloat(197)/255, green: CGFloat(234)/255, blue: CGFloat(138)/255, alpha: 1.0)
        main2 = UIColor(red: CGFloat(255)/255, green: CGFloat(225)/255, blue: CGFloat(124)/255, alpha: 1.0)
        main3 = UIColor(red: CGFloat(255)/255, green: CGFloat(220)/255, blue: CGFloat(132)/255, alpha: 1.0)
        main4 = UIColor(red: CGFloat(255)/255, green: CGFloat(202)/255, blue: CGFloat(84)/255, alpha: 1.0)
