...
open class KCFloatingActionButtonItem: UIView {
    ...
    open var size: CGFloat = 42 {
        didSet {
            ...
            _iconImageView?.center = CGPoint(x: size/2 - 15, y: size/2) + imageOffset
    ...
    /**
     Circle Shadow color.
     */
    open var circleShadowColor: UIColor = UIColor.clear
    ...
    open var title: String? = nil {
        didSet {
            ...
            titleLabel.frame.origin.x = -titleLabel.frame.size.width - 10 - 15
    ...
    */
    ...
    fileprivate func createCircleLayer() {
        ...
        circleLayer.frame = CGRect(x: castParent.itemSize/2 - (size/2) - 15, y: 0, width: size, height: size)
